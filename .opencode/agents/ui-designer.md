...
tools:
  ...
  grep: true
---
<!-- GENERADO por link-world-agents-opencode.ps1 desde _shared/agents/react/ui-designer.md - adaptado para OpenCode (tools/color). No editar aqui: editar la fuente y re-ejecutar el script. -->
