...
---
<!-- GENERADO por link-world-agents-opencode.ps1 desde _shared/agents/core/debugger.md - adaptado para OpenCode (tools/color). No editar aqui: editar la fuente y re-ejecutar el script. -->
